...
(cl:defmethod cl:initialize-instance :after ((m <Mavlink>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Mavlink)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name mavlink-msg:<Mavlink> is deprecated: use mavlink-msg:Mavlink instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <Mavlink>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mavlink-msg:header-val is deprecated.  Use mavlink-msg:header instead.")
  (header m))

(cl:ensure-generic-function 'len-val :lambda-list '(m))
(cl:defmethod len-val ((m <Mavlink>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mavlink-msg:len-val is deprecated.  Use mavlink-msg:len instead.")
  (len m))

(cl:ensure-generic-function 'seq-val :lambda-list '(m))
(cl:defmethod seq-val ((m <Mavlink>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mavlink-msg:seq-val is deprecated.  Use mavlink-msg:seq instead.")
  (seq m))

(cl:ensure-generic-function 'sysid-val :lambda-list '(m))
(cl:defmethod sysid-val ((m <Mavlink>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mavlink-msg:sysid-val is deprecated.  Use mavlink-msg:sysid instead.")
  (sysid m))

(cl:ensure-generic-function 'compid-val :lambda-list '(m))
(cl:defmethod compid-val ((m <Mavlink>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mavlink-msg:compid-val is deprecated.  Use mavlink-msg:compid instead.")
  (compid m))

(cl:ensure-generic-function 'msgid-val :lambda-list '(m))
(cl:defmethod msgid-val ((m <Mavlink>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mavlink-msg:msgid-val is deprecated.  Use mavlink-msg:msgid instead.")
  (msgid m))

(cl:ensure-generic-function 'fromlcm-val :lambda-list '(m))
(cl:defmethod fromlcm-val ((m <Mavlink>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mavlink-msg:fromlcm-val is deprecated.  Use mavlink-msg:fromlcm instead.")
  (fromlcm m))

(cl:ensure-generic-function 'payload64-val :lambda-list '(m))
(cl:defmethod payload64-val ((m <Mavlink>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mavlink-msg:payload64-val is deprecated.  Use mavlink-msg:payload64 instead.")
  (payload64 m))
